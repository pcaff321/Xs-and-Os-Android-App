...
public final class ActivitySinglePlayerViewBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySinglePlayerViewBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivitySinglePlayerViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySinglePlayerViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_single_player_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySinglePlayerViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySinglePlayerViewBinding((ConstraintLayout) rootView, button00, button01,
